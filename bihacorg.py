...
if __name__ == "__main__":
    ...
    run_single_source("https://www.bihac.org/materijali", "Grad Bihać - Materijali", "bihacorg_state.json")
    run_single_source("https://www.bihac.org/vijesti", "Grad Bihać - Vijesti", "bihacorg_state.json")
