...
# Configuration
SCRAPERS=(
    # New separated per-site scripts only
    "cinestar_bihac.py"
    "ggbihac.py"
    "unbi.py"
    "fzs_unbi.py"
    ...
    "avaz_bihac_tag.py"
    "haber_usk.py"
    "crna_hronika_bihac.py"
    "raport_bihac.py"
    #"indexhr_bihac.py"
    "n1info_grad_bihac.py"
    "biznisinfo_bihac.py"
    "faktor_mup_usk.py"
    "faktor_bihac.py"
    "oslobodjenje_bihac_tag.py"
    #"bljesak_bihac.py"
    #"mondo_bihac.py"
    #"stav_bihac.py"
    "vecernji_bihac.py"
...
LOG_FILE="/home/bihac-danas/web-scraper/scraper_log"
